    ...
    return (
        ...
        <div className='flex flex-wrap w-10/12 lg:w-full justify-evenly gap-8'>
            {products.map(product => (
                <div key={product.id} className="flex flex-col md:flex-row items-center md:gap-5 md:w-10/12 lg:w-5/12 hover:scale-110 hover:shadow-2xl ease-in-out transition duration-500 shadow-zinc-900 rounded-md">
                    ...
                    <div className="flex flex-col gap-2 p-4 h-full">
                        ...
                        <p className="text-md md:text-lg text-center font-light">${product.price}</p>
