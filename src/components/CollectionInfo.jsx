    ...
    return (
        <div className='flex justify-center'>
            <div className='w-10/12'>
                <p className={`md:text-lg text-xs text-center ${showFullText ? 'h-auto' : 'sm:h-fit h-20 line-clamp-5 sm:line-clamp-none'}`}>
                ...
                <div className='flex justify-evenly mt-4 md:mt-16 flex-wrap'>
                    ...
                    <img src='/img/outfit-2.png' alt='outfit2' className='w-5/12 sm:w-3/12 xl:w-2/12 rounded-md'/>
                    <img src='/img/outfit-3.png' alt='outfit3' className='w-5/12 sm:w-3/12 xl:w-2/12 rounded-md'/>
                    <img src='/img/outfit-4.png' alt='outfit4' className='w-5/12 sm:w-3/12 xl:w-2/12 rounded-md'/>
                    <img src='/img/outfit-5.png' alt='outfit5' className='w-5/12 sm:w-3/12 xl:w-2/12 rounded-md'/>
                </div>
            </div>
        </div>
    )
